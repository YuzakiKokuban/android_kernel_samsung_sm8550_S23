...
<p align="center">
<a href="https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_S23/releases"><img src="https://img.shields.io/github/v/release/YuzakiKokuban/android_kernel_samsung_sm8550_S23?style=for-the-badge&logo=github&color=blue" alt="GitHub release"></a>
...
* **版本标识**：`-android13-Kokuban-Firefly-EZB6`
...
3. **刷入内核**：从本项目 [Releases 页面](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_S23/releases) 下载对应版本，并在 Recovery 中刷入内核 `zip` 包。
...
所有最新构建版本均发布于 [**Releases 页面**](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_S23/releases)。
...
* **Version Identifier**: `-android13-Kokuban-Firefly-EZB6`
...
3. **Flash the Kernel**: Download the appropriate package from the [Releases page](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_S23/releases) and flash the kernel `zip` through Recovery.
...
All current builds are published on the [**Releases Page**](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_S23/releases).
